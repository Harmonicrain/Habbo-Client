package com.sulake.habbo.communication.messages.incoming.userdefinedroomevents
{
    ...
    /**
     * Wired 2.0 base definition. Reads the expanded packet in the exact order the
     * Arcturus InteractionWired.serializeWiredDataNew writes it. Replaces the
     * legacy Triggerable once the coordinated cutover lands.
     *
     * Two virtual hooks let subclasses read their type-specific fields:
     *   readDefinitionSpecifics  - between `code` and advancedMode
     *   readTypeSpecifics        - between allowWallFurni and WiredContext
     */
    public class WiredElementDefinition
    {
        ...
        public function WiredElementDefinition(k:IMessageDataWrapper)
        {
