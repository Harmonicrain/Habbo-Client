package com.sulake.habbo.roomevents.wired_setup.triggerconfs
{
    ...
    public class TriggerPeriodicallyLongElement extends DefaultElement
    {
        private var _time:SliderSection;

        public function TriggerPeriodicallyLongElement()
        {
            super();
        }
        ...
        {
            this._time = _arg_1.createSliderSection("wiredfurni.params.setlongtime", "time", new SliderValueSeconds5(), 1, 120, 1);
