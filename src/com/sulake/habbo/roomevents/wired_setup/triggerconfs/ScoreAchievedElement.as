package com.sulake.habbo.roomevents.wired_setup.triggerconfs
{
    ...
    public class ScoreAchievedElement extends DefaultElement
    {
        private var _score:SliderSection;
        private var _team:RadioGroupPreset;

        public function ScoreAchievedElement()
        {
            super();
        }
        ...
        override public function buildInputs(_arg_1:PresetManager, _arg_2:WiredStyle, _arg_3:WiredUIBuilder):void
        {
            ...
            this._score = _arg_1.createSliderSection("wiredfurni.params.setscore2", "points", new SliderValueEcho(), 1, 1000, 1);
            _arg_3.addElements(_arg_1.createSection(l("team"), this._team), this._score);
        }
        ...
        {
            this._score.value = (_arg_1.intData.length > 0) ? _arg_1.intData[0] : 1;
            this._team.selected = (_arg_1.intData.length > 1) ? _arg_1.intData[1] : 0;
        }
    }
}
