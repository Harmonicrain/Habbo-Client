package com.sulake.habbo.roomevents.wired_setup.triggerconfs
{
    ...
    public class TriggerPeriodicallyElement extends DefaultElement
    {
        private var _time:SliderSection;

        public function TriggerPeriodicallyElement()
        {
            super();
        }
        ...
        {
            this._time = _arg_1.createSliderSection("wiredfurni.params.settime", "seconds", SliderSection.CONVERTER_PULSES, 1, 120, 1);
