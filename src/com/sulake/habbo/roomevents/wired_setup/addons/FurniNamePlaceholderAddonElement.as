package com.sulake.habbo.roomevents.wired_setup.addons
{
    ...
    /** July addon 19: furniture-name placeholder definition. */
    public class FurniNamePlaceholderAddonElement extends DefaultElement
    {
        private var _name:PlaceholderNameSection;
        private var _type:PlaceholderTypeSection;

        override public function get code():int { return AddonCodes.FURNI_NAME_PLACEHOLDER; }
                                             ...
                                             builder:WiredUIBuilder):void
        {
            ...
            this._type = manager.createPlaceholderTypeSection("furni");
        ...
        override public function readIntParamsFromForm():Array { return [this._type.isShowMultiple ? 1 : 0]; }
