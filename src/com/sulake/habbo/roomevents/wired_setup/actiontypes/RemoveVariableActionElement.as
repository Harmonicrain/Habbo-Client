package com.sulake.habbo.roomevents.wired_setup.actiontypes
{
    ...
    /** July AIR action 40: remove the selected variable from its target. */
    public class RemoveVariableActionElement extends DefaultElement
    {
        private var _picker:VariablePickerPreset;
        private var _selectionSection:SectionPreset;
        private var _target:int = 0;

        override public function get code():int { return ActionTypeCodes.REMOVE_VARIABLE; }
                                             ...
                                             builder:WiredUIBuilder):void
        {
            ...
            this._selectionSection = manager.createSection(
                this.loc("wiredfurni.params.variables.variable_selection"), this._picker,
