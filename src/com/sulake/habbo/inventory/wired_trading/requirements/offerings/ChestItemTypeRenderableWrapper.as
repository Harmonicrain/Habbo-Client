package com.sulake.habbo.inventory.wired_trading.requirements.offerings
{
    ...
    public class ChestItemTypeRenderableWrapper implements IProductDisplayInfo
    {
        ...
        public function ChestItemTypeRenderableWrapper(type:ChestItemType)
        {
            this._type = type;
        }

        public function get productTypeId():int
        { return this._type.isWallItem ? 0 : 1; }
        public function get itemTypeId():String
        { return String(this._type.typeId); }
        public function get extraData():String
        { return this._type.legacyPosterId; }
